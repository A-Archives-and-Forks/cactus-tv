...
try {
  ...
  for (const ref of ['/styles.css?v=1.2.1', '/js/app.js?v=1.2.1']) {
...
try {
  ...
  for (const token of ['applyCleanStream', "import('./player.js?v=1.2.1')", "import('./player-ui.js?v=1.2.1')", 'buildPersonalizedHome']) {
...
try {
  ...
  for (const token of ['maxBufferLength: profile.targetBuffer', 'baselineEstimate', 'requestSessionWakeLock', 'emergencyDownshift', 'capLevelOnFPSDrop', 'abrMaxWithRealBitrate']) {
