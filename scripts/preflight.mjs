...
try {
  ...
  for (const ref of ['/styles.css?v=1.2.0', '/js/app.js?v=1.2.0']) {
...
try {
  ...
  for (const token of ['applyCleanStream', "import('./player.js?v=1.2.0')", "import('./player-ui.js?v=1.2.0')", 'buildPersonalizedHome']) {
...
try {
  ...
  for (const token of ['maxBufferLength: profile.startupBuffer', 'scheduleBufferRamp', 'requestSessionWakeLock', 'emergencyDownshift', 'capLevelOnFPSDrop', 'abrMaxWithRealBitrate']) {
